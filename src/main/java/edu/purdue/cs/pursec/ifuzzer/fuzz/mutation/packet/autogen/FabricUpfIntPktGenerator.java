...
//source: /home/intender/Workspace-remote/fabric-tna/fabric_v1model_upf_int_ir.json
...
public class FabricUpfIntPktGenerator extends AutogenP4PktGenerator {
    enum ParserError {
        NoError,
        PacketTooShort,
        NoMatch,
    ...
    private static Logger log = LoggerFactory.getLogger(FabricUpfIntPktGenerator.class);
...
//            parser_error.decode(bitStream);
    ...
    class report_fixed_header_t extends P4TypeHeader {
        ...
        BitVariable nproto = new BitVariable(4);
        BitVariable dqf = new BitVariable(3);
        BitVariable rsvd = new BitVariable(15);
        BitVariable hw_id = new BitVariable(6);
        BitVariable seq_no = new BitVariable(32);
        BitVariable ig_tstamp = new BitVariable(32);
    ...
    class common_report_header_t extends P4TypeHeader {
        boolean isValid = false;
        BitVariable switch_id = new BitVariable(32);
        BitVariable pad1 = new BitVariable(7);
        BitVariable ig_port = new BitVariable(9);
        BitVariable pad2 = new BitVariable(7);
        BitVariable eg_port = new BitVariable(9);
        BitVariable pad3 = new BitVariable(3);
        BitVariable queue_id = new BitVariable(5);
    ...
    class local_report_header_t extends P4TypeHeader {
        boolean isValid = false;
        BitVariable pad1 = new BitVariable(5);
        BitVariable queue_occupancy = new BitVariable(19);
        BitVariable eg_tstamp = new BitVariable(32);
    ...
    class int_report_metadata_t extends P4TypeHeader {
        boolean isValid = false;
        ...
        BitVariable ig_port = new BitVariable(9);
        BitVariable _pad2 = new BitVariable(7);
        BitVariable eg_port = new BitVariable(9);
        BitVariable _pad3 = new BitVariable(3);
        BitVariable queue_id = new BitVariable(5);
        BitVariable _pad4 = new BitVariable(5);
        BitVariable queue_occupancy = new BitVariable(19);
        BitVariable ig_tstamp = new BitVariable(32);
        BitVariable eg_tstamp = new BitVariable(32);
        BitVariable drop_reason = new BitVariable(8);
        BitVariable ip_eth_type = new BitVariable(16);
        BitVariable _pad5 = new BitVariable(6);
        BitVariable encap_presence = new BitVariable(2);
        BitVariable report_type = new BitVariable(3);
        BitVariable _pad6 = new BitVariable(5);
        BitVariable flow_hash = new BitVariable(32);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            if (isValid) {
                ...
                ig_port.decode(bitStream);
                _pad2.decode(bitStream);
                eg_port.decode(bitStream);
                _pad3.decode(bitStream);
                queue_id.decode(bitStream);
                _pad4.decode(bitStream);
                queue_occupancy.decode(bitStream);
                ig_tstamp.decode(bitStream);
                eg_tstamp.decode(bitStream);
                drop_reason.decode(bitStream);
                ip_eth_type.decode(bitStream);
                _pad5.decode(bitStream);
                encap_presence.decode(bitStream);
                report_type.decode(bitStream);
                _pad6.decode(bitStream);
                flow_hash.decode(bitStream);
            }
        }
    ...
    class int_bridged_metadata_t extends P4TypeStruct {
        BitVariable report_type = new BitVariable(3);
        BitVariable mirror_session_id = new BitVariable(10);
        BitVariable drop_reason = new BitVariable(8);
        BitVariable queue_id = new BitVariable(5);
        BitVariable egress_port = new BitVariable(9);
        BitVariable wip_type = new BitVariable(8);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            queue_id.decode(bitStream);
            egress_port.decode(bitStream);
            wip_type.decode(bitStream);
        }
    }

    class int_metadata_t extends P4TypeStruct {
        BitVariable hop_latency = new BitVariable(32);
        BitVariable timestamp = new BitVariable(48);
        BitVariable vlan_stripped = new BitVariable(1);
        BitVariable queue_report = new BitVariable(1);

        @Override
        public void decode(BitVarOutputStream bitStream) throws IOException {
            hop_latency.decode(bitStream);
            timestamp.decode(bitStream);
            vlan_stripped.decode(bitStream);
            queue_report.decode(bitStream);
        }
    }
    ...
    class bridged_metadata_t extends P4TypeHeader {
        ...
        BitVariable _int_bmd_report_type21 = new BitVariable(3);
        BitVariable _int_bmd_mirror_session_id22 = new BitVariable(10);
        BitVariable _int_bmd_drop_reason23 = new BitVariable(8);
        BitVariable _int_bmd_queue_id24 = new BitVariable(5);
        BitVariable _int_bmd_egress_port25 = new BitVariable(9);
        BitVariable _int_bmd_wip_type26 = new BitVariable(8);
        BitVariable __pad027 = new BitVariable(1);
        BitVariable __pad128 = new BitVariable(7);
        BitVariable __pad229 = new BitVariable(5);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            if (isValid) {
                ...
                _int_bmd_report_type21.decode(bitStream);
                _int_bmd_mirror_session_id22.decode(bitStream);
                _int_bmd_drop_reason23.decode(bitStream);
                _int_bmd_queue_id24.decode(bitStream);
                _int_bmd_egress_port25.decode(bitStream);
                _int_bmd_wip_type26.decode(bitStream);
                __pad027.decode(bitStream);
                __pad128.decode(bitStream);
                __pad229.decode(bitStream);
            }
        }
    ...
    class fabric_egress_metadata_t extends P4TypeStruct {
        ...
        BitVariable inner_ipv4_checksum_err = new BitVariable(1);
        int_report_metadata_t int_report_md = new int_report_metadata_t();
        int_metadata_t int_md = new int_metadata_t();
        BitVariable int_ipv4_len = new BitVariable(16);
        BitVariable is_int_recirc = new BitVariable(1);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            inner_ipv4_checksum_err.decode(bitStream);
            int_report_md.decode(bitStream);
            int_md.decode(bitStream);
            int_ipv4_len.decode(bitStream);
            is_int_recirc.decode(bitStream);
    ...
    class egress_headers_t extends P4TypeStruct {
        ...
        eth_type_t report_eth_type = new eth_type_t();
        mpls_t report_mpls = new mpls_t();
        ...
        common_report_header_t common_report_header = new common_report_header_t();
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            report_eth_type.decode(bitStream);
            report_mpls.decode(bitStream);
            report_ipv4.decode(bitStream);
            report_udp.decode(bitStream);
            report_fixed_header.decode(bitStream);
            common_report_header.decode(bitStream);
    ...
    class fabric_v1model_metadata_t extends P4TypeStruct {
        ...
        int_report_metadata_t _egress_int_report_md39 = new int_report_metadata_t();
        BitVariable _egress_int_md_hop_latency40 = new BitVariable(32);
        BitVariable _egress_int_md_timestamp41 = new BitVariable(48);
        BitVariable _egress_int_md_vlan_stripped42 = new BitVariable(1);
        BitVariable _egress_int_md_queue_report43 = new BitVariable(1);
        BitVariable _egress_int_ipv4_len44 = new BitVariable(16);
        BitVariable _egress_is_int_recirc45 = new BitVariable(1);
        BitVariable _egress_pkt_length46 = new BitVariable(16);
        BitVariable _recirc_preserved_report_type47 = new BitVariable(3);
        BitVariable _recirc_preserved_egress_port48 = new BitVariable(9);
        BitVariable _recirc_preserved_drop_reason49 = new BitVariable(8);
        BitVariable _recirc_preserved_ingress_port50 = new BitVariable(9);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            _egress_int_report_md39.decode(bitStream);
            _egress_int_md_hop_latency40.decode(bitStream);
            _egress_int_md_timestamp41.decode(bitStream);
            _egress_int_md_vlan_stripped42.decode(bitStream);
            _egress_int_md_queue_report43.decode(bitStream);
            _egress_int_ipv4_len44.decode(bitStream);
            _egress_is_int_recirc45.decode(bitStream);
            _egress_pkt_length46.decode(bitStream);
            _recirc_preserved_report_type47.decode(bitStream);
            _recirc_preserved_egress_port48.decode(bitStream);
            _recirc_preserved_drop_reason49.decode(bitStream);
            _recirc_preserved_ingress_port50.decode(bitStream);
        }
    }
    ...
    class v1model_header_t extends P4TypeStruct {
        ...
        ethernet_t _egress_report_ethernet24 = new ethernet_t();
        eth_type_t _egress_report_eth_type25 = new eth_type_t();
        mpls_t _egress_report_mpls26 = new mpls_t();
        ipv4_t _egress_report_ipv427 = new ipv4_t();
        udp_t _egress_report_udp28 = new udp_t();
        report_fixed_header_t _egress_report_fixed_header29 = new report_fixed_header_t();
        common_report_header_t _egress_common_report_header30 = new common_report_header_t();
        local_report_header_t _egress_local_report_header31 = new local_report_header_t();
        drop_report_header_t _egress_drop_report_header32 = new drop_report_header_t();
        ethernet_t _egress_ethernet33 = new ethernet_t();
        vlan_tag_t _egress_vlan_tag34 = new vlan_tag_t();
        eth_type_t _egress_eth_type35 = new eth_type_t();
        mpls_t _egress_mpls36 = new mpls_t();
        ipv4_t _egress_outer_ipv437 = new ipv4_t();
        udp_t _egress_outer_udp38 = new udp_t();
        gtpu_t _egress_outer_gtpu39 = new gtpu_t();
        gtpu_options_t _egress_outer_gtpu_options40 = new gtpu_options_t();
        gtpu_ext_psc_t _egress_outer_gtpu_ext_psc41 = new gtpu_ext_psc_t();
        ipv4_t _egress_ipv442 = new ipv4_t();
        ipv6_t _egress_ipv643 = new ipv6_t();
        udp_t _egress_udp44 = new udp_t();
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            _egress_report_ethernet24.decode(bitStream);
            _egress_report_eth_type25.decode(bitStream);
            _egress_report_mpls26.decode(bitStream);
            _egress_report_ipv427.decode(bitStream);
            _egress_report_udp28.decode(bitStream);
            _egress_report_fixed_header29.decode(bitStream);
            _egress_common_report_header30.decode(bitStream);
            _egress_local_report_header31.decode(bitStream);
            _egress_drop_report_header32.decode(bitStream);
            _egress_ethernet33.decode(bitStream);
            _egress_vlan_tag34.decode(bitStream);
            _egress_eth_type35.decode(bitStream);
            _egress_mpls36.decode(bitStream);
            _egress_outer_ipv437.decode(bitStream);
            _egress_outer_udp38.decode(bitStream);
            _egress_outer_gtpu39.decode(bitStream);
            _egress_outer_gtpu_options40.decode(bitStream);
            _egress_outer_gtpu_ext_psc41.decode(bitStream);
            _egress_ipv442.decode(bitStream);
            _egress_ipv643.decode(bitStream);
            _egress_udp44.decode(bitStream);
        }
    }
    ...
    private void start() {
        log.debug("START");
        stateList.add("START");
        fabric_md._egress_pkt_length46 = (BitVariable) standard_md.packet_length;
        ...
        fabric_md._recirc_preserved_ingress_port50 = standard_md.ingress_port;
        ...
        fabric_md._ingress_bridged4._int_bmd_drop_reason23.putValue(0);
        fabric_md._ingress_bridged4._int_bmd_wip_type26.putValue(0);
        ...
        if (caseNum == 0) {
            ...
            tmp_8.slice(15, 0).putValue(48900);
            parse_int_wip_ipv4();
        } else if (caseNum == 4) {
            tmp_8.slice(15, 0).putValue(48901);
            parse_int_wip_mpls();
        } else {
            parse_ethernet();
        }
    ...
    private void parse_int_wip_ipv4() {
        log.debug("PARSE_INT_WIP_IPV4");
        stateList.add("PARSE_INT_WIP_IPV4");
        hdr._ingress_ethernet3.isValid = true;
        hdr._ingress_eth_type5.isValid = true;
        hdr._ingress_eth_type5.value.putValue(2048);
        fabric_md._ingress_bridged4._int_bmd_wip_type26.putValue(1);
    ...
    private void parse_int_wip_mpls() {
        log.debug("PARSE_INT_WIP_MPLS");
        stateList.add("PARSE_INT_WIP_MPLS");
        hdr._ingress_ethernet3.isValid = true;
        hdr._ingress_eth_type5.isValid = true;
        hdr._ingress_eth_type5.value.putValue(34887);
        fabric_md._ingress_bridged4._int_bmd_wip_type26.putValue(2);
        //advance: packet.advance
        pos += 112;
        if (parserStateItr != null && parserStateItr.hasNext())
            parserStateItr.next();
    ...
    private void parse_fake_ethernet() {
        ...
        if (caseNum == 0) {
            tmp_10.slice(15, 0).putValue(48900);
            parse_int_wip_ipv4();
        } else if (caseNum == 1) {
            tmp_10.slice(15, 0).putValue(48901);
            parse_int_wip_mpls();
        } else {
            parse_ethernet();
        }
