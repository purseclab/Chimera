...
import edu.purdue.cs.pursec.ifuzzer.fuzz.guidance.intent.api.TopologyIntentGuidanceConfigs;
...
public class TopologyIntentGuidance implements FuzzIntentGuidance {
    ...
    public void updateCoverage(JavaCodeCoverage that) {
        if (this.codeCoverage == null)
            this.codeCoverage = new JavaCodeCoverage();
