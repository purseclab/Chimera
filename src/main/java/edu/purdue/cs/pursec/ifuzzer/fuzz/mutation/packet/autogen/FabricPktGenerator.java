...
//source: /home/intender/Workspace-remote/fabric-tna/fabric_v1model_ir.json
...
public class FabricPktGenerator extends AutogenP4PktGenerator {
    enum ParserError {
        NoError,
        PacketTooShort,
        NoMatch,
    ...
    private static Logger log = LoggerFactory.getLogger(FabricPktGenerator.class);
...
//            parser_error.decode(bitStream);
    ...
    class bridged_metadata_t extends P4TypeHeader {
        ...
        BitVariable __pad013 = new BitVariable(1);
    ...
    class fabric_v1model_metadata_t extends P4TypeStruct {
        ...
        BitVariable _egress_pkt_length38 = new BitVariable(16);
        BitVariable _recirc_preserved_report_type39 = new BitVariable(3);
        BitVariable _recirc_preserved_egress_port40 = new BitVariable(9);
        BitVariable _recirc_preserved_drop_reason41 = new BitVariable(8);
        BitVariable _recirc_preserved_ingress_port42 = new BitVariable(9);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            _egress_pkt_length38.decode(bitStream);
            _recirc_preserved_report_type39.decode(bitStream);
            _recirc_preserved_egress_port40.decode(bitStream);
            _recirc_preserved_drop_reason41.decode(bitStream);
            _recirc_preserved_ingress_port42.decode(bitStream);
        }
    }
    ...
    class v1model_header_t extends P4TypeStruct {
        ...
        ipv4_t _egress_ipv428 = new ipv4_t();
        ipv6_t _egress_ipv629 = new ipv6_t();
        udp_t _egress_udp30 = new udp_t();
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            _egress_ipv428.decode(bitStream);
            _egress_ipv629.decode(bitStream);
            _egress_udp30.decode(bitStream);
        }
    }
    ...
    private void start() {
        log.debug("START");
        stateList.add("START");
        fabric_md._egress_pkt_length38 = (BitVariable) standard_md.packet_length;
        ...
        fabric_md._recirc_preserved_ingress_port42 = standard_md.ingress_port;
