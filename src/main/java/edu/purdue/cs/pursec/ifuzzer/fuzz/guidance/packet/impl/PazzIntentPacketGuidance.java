...
public class PazzIntentPacketGuidance implements FuzzIntentPacketGuidance {
    private static Logger log = LoggerFactory.getLogger(PazzIntentPacketGuidance.class);
    ...
    public PazzIntentPacketGuidance() {
