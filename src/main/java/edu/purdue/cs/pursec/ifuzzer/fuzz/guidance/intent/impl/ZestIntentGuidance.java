package edu.purdue.cs.pursec.ifuzzer.fuzz.guidance.intent.impl;

import com.google.gson.JsonObject;
import edu.purdue.cs.pursec.ifuzzer.api.ConfigConstants;
import edu.purdue.cs.pursec.ifuzzer.fuzz.result.SingleIntentFuzzResult;
...
import edu.purdue.cs.pursec.ifuzzer.fuzz.guidance.intent.api.ZestIntentGuidanceConfigs;
...
import edu.purdue.cs.pursec.ifuzzer.fuzz.guidance.api.CoverageGuidance;
...
public class ZestIntentGuidance implements FuzzIntentGuidance {
    ...
    JavaCodeCoverage wholeCoverage;
    JavaCodeCoverage totalCoverage;
    JavaCodeCoverage validCoverage;
    ...
    public String getStatsHeader() {
        return JavaCodeCoverage.getStatsHeader() + ", " + SingleIntentFuzzResult.getStatsHeader() +
    ...
    public boolean feedbackResult(@Nonnull FuzzScenario scenario) {
        ...
        JavaCodeCoverage runningCoverage = scenario.getCodeCoverage();
...
//            Collection<?> newCovList = runningCoverage.computeNewCoverage(totalCoverage);
    ...
    private Set<Object> computeResponsibilities(JavaCodeCoverage coverage, boolean valid) {
//        Set<Object> result = new HashSet<>();
    ...
    protected void saveCurrentInput(JavaCodeCoverage runCoverage, Set<Object> responsibilities, String why) throws IOException {
    ...
    private void start(Collection<Input> inputs) {
        ...
        wholeCoverage = new JavaCodeCoverage();
        totalCoverage = new JavaCodeCoverage();
        validCoverage = new JavaCodeCoverage();
    ...
    public static abstract class Input<K> implements Iterable<Integer> {
         ...
         * <p>This field is null for inputs that are not saved.</p>
         */
        JavaCodeCoverage coverage = null;
         ...
         * redundant (can be computed using {@link JavaCodeCoverage#getHitCount()}),
