...
//source: /home/intender/Workspace-remote/fabric-tna/fabric_v1model_int_ir.json
...
public class FabricIntPktGenerator extends AutogenP4PktGenerator {
    enum ParserError {
        NoError,
        PacketTooShort,
        NoMatch,
    ...
    private static Logger log = LoggerFactory.getLogger(FabricIntPktGenerator.class);
...
//            parser_error.decode(bitStream);
    ...
    class bridged_metadata_t extends P4TypeHeader {
        ...
        BitVariable _int_bmd_report_type13 = new BitVariable(3);
        BitVariable _int_bmd_mirror_session_id14 = new BitVariable(10);
        BitVariable _int_bmd_drop_reason15 = new BitVariable(8);
        BitVariable _int_bmd_queue_id16 = new BitVariable(5);
        BitVariable _int_bmd_egress_port17 = new BitVariable(9);
        BitVariable _int_bmd_wip_type18 = new BitVariable(8);
        BitVariable __pad019 = new BitVariable(1);
        BitVariable __pad220 = new BitVariable(5);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            if (isValid) {
                ...
                _int_bmd_report_type13.decode(bitStream);
                _int_bmd_mirror_session_id14.decode(bitStream);
                _int_bmd_drop_reason15.decode(bitStream);
                _int_bmd_queue_id16.decode(bitStream);
                _int_bmd_egress_port17.decode(bitStream);
                _int_bmd_wip_type18.decode(bitStream);
                __pad019.decode(bitStream);
                __pad220.decode(bitStream);
            }
        }
    ...
    class fabric_v1model_metadata_t extends P4TypeStruct {
        ...
        int_report_metadata_t _egress_int_report_md38 = new int_report_metadata_t();
        BitVariable _egress_int_md_hop_latency39 = new BitVariable(32);
        BitVariable _egress_int_md_timestamp40 = new BitVariable(48);
        BitVariable _egress_int_md_vlan_stripped41 = new BitVariable(1);
        BitVariable _egress_int_md_queue_report42 = new BitVariable(1);
        BitVariable _egress_int_ipv4_len43 = new BitVariable(16);
        BitVariable _egress_is_int_recirc44 = new BitVariable(1);
        BitVariable _egress_pkt_length45 = new BitVariable(16);
        BitVariable _recirc_preserved_report_type46 = new BitVariable(3);
        BitVariable _recirc_preserved_egress_port47 = new BitVariable(9);
        BitVariable _recirc_preserved_drop_reason48 = new BitVariable(8);
        BitVariable _recirc_preserved_ingress_port49 = new BitVariable(9);
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            _egress_int_report_md38.decode(bitStream);
            _egress_int_md_hop_latency39.decode(bitStream);
            _egress_int_md_timestamp40.decode(bitStream);
            _egress_int_md_vlan_stripped41.decode(bitStream);
            _egress_int_md_queue_report42.decode(bitStream);
            _egress_int_ipv4_len43.decode(bitStream);
            _egress_is_int_recirc44.decode(bitStream);
            _egress_pkt_length45.decode(bitStream);
            _recirc_preserved_report_type46.decode(bitStream);
            _recirc_preserved_egress_port47.decode(bitStream);
            _recirc_preserved_drop_reason48.decode(bitStream);
            _recirc_preserved_ingress_port49.decode(bitStream);
        }
    }
    ...
    class v1model_header_t extends P4TypeStruct {
        ...
        ipv4_t _egress_ipv437 = new ipv4_t();
        ipv6_t _egress_ipv638 = new ipv6_t();
        udp_t _egress_udp39 = new udp_t();
        ...
        public void decode(BitVarOutputStream bitStream) throws IOException {
            ...
            _egress_ipv437.decode(bitStream);
            _egress_ipv638.decode(bitStream);
            _egress_udp39.decode(bitStream);
        }
    }
    ...
    private void start() {
        log.debug("START");
        stateList.add("START");
        fabric_md._egress_pkt_length45 = (BitVariable) standard_md.packet_length;
        ...
        fabric_md._recirc_preserved_ingress_port49 = standard_md.ingress_port;
        ...
        fabric_md._ingress_bridged4._int_bmd_drop_reason15.putValue(0);
        fabric_md._ingress_bridged4._int_bmd_wip_type18.putValue(0);
    ...
    private void parse_int_wip_ipv4() {
        ...
        fabric_md._ingress_bridged4._int_bmd_wip_type18.putValue(1);
    ...
    private void parse_int_wip_mpls() {
        ...
        fabric_md._ingress_bridged4._int_bmd_wip_type18.putValue(2);
        //advance: packet.advance
        pos += 112;
        if (parserStateItr != null && parserStateItr.hasNext())
            parserStateItr.next();
