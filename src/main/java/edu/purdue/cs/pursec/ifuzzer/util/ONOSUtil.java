...
public class ONOSUtil {
    ...
    public static final String ONOSCovOutputFile = "allBranch.out";
    ...
    public static String getONOSClassListOutputFilePath() {
        return IFuzzer.rootPath + File.separator + properties.getProperty(ONOSConstants.ONOS_CLASS_LIST_OUTPUT_FILE_PATH);
    }
    ...
    public static String getFlowRulesFromONOS(String deviceId) throws IOException {
        return getRestFromONOS("flows/" + deviceId);
    }
    ...
    public static HttpURLConnection setNetcfgToONOS(JsonObject netcfgJson) throws IOException {

        log.debug("set netcfg json into ONOS");
        ...
        OutputStream os = conn.getOutputStream();
        if (netcfgJson != null)
            os.write(netcfgJson.toString().getBytes("utf-8"));
        os.close();
