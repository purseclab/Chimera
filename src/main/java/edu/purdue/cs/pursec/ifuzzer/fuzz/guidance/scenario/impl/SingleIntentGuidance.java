...
import edu.purdue.cs.pursec.ifuzzer.fuzz.guidance.intent.impl.ZestIntentGuidance;
...
public class SingleIntentGuidance extends FuzzIntentScenarioGuidance {
    ...
    public FuzzScenario getRandomScenario(FuzzScenario scenario)
            throws IOException, JsonSyntaxException, EndFuzzException,
                   GuidanceException, SkipFuzzException {
